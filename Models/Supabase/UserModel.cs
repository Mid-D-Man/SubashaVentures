// Models/Supabase/UserModel.cs — UPDATED: added is_partner, partner_id, partner_applied_at
...
public class UserModel : BaseModel
{
    ...
    // ── Partner Fields (added by migration 001) ────────────────
    /// <summary>
    /// TRUE once a partner application has been approved.
    /// Set by the approve-partner-application edge function.
    /// </summary>
    [Column("is_partner")]
    public bool IsPartner { get; set; } = false;

    /// <summary>
    /// FK to partners.id. NULL until approved.
    /// </summary>
    [Column("partner_id")]
    public Guid? PartnerId { get; set; }

    /// <summary>
    /// Timestamp of the most recent partner application submission.
    /// </summary>
    [Column("partner_applied_at")]
